// This module will restart tmux if it is shut down for any reason
// It was added so that the TMUX Logger could be run on older tmux instances. TMUX itself needed to be updated, which required a shutdown of the TMUX
//      and an end to all running processes. This module allowed for TMUX to be restarted and all of its processes initiated on restart.
// Its use is limited after that
